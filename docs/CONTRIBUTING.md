...
The code for the documentation and the website are located in the modern-mean/modern-mean-core repo on the gh-pages branch. The website is hosted by github pages and generated using jekyll. See the README in the gh-pages branch for more information on how to get your dev environment set-up.
